...
const ScheduleReportForm = ({onCloseDrawer}: {onCloseDrawer: () => void}) => {
  ...
  console.log("ScheduleReportForm component mounted");
  console.log("Current user:", user);
  console.log("Current reportSetting:", reportSetting);
  ...
  const onSubmit = (values: FormValues) => {
    console.log("Report settings form submitted with values:", values);
    
    // Only send isEnabled as that's all the API expects
    const payload = {
      isEnabled: values.isEnabled
    }
    
    console.log("Sending payload to updateReportSetting:", payload);
    
    updateReportSetting(payload).unwrap().then(() => {
      console.log("Report setting updated successfully");
